      ...
      <div className="flex flex-col">
        ...
        <div className="px-[16px] mb-4">
          {user.bank_details.isLedger ? (
            <div className="border flex flex-col gap-6 bg-[#12604a] text-white p-4 rounded-lg">
              ...
              <div className="flex items-center justify-between">
                <span className="font-[400] text-[20px]">
                  {hideBalance
                    ? "******"
                    : `${formatCurrency(user.bank_details.ledger_balance_usd ?? 0)}`}
                </span>
                <Link
                  href="/dashboard/transfer"
                  className="p-[5px_20px] rounded-full bg-white text-[#12604a] text-[14px]"
                >
                  Send money
                </Link>
              </div>
            ...
            <div className="flex flex-col justify-between gap-4 bg-[#12604a] text-white p-4 rounded-lg">
              ...
              <div className="flex justify-between gap-6">
                ...
                <div className="flex flex-col gap-5">
                  <Link
                    href="/dashboard/transfer"
                    className="p-[5px_20px] flex rounded-full bg-white text-[#12604a] text-[14px]"
                  >
                    Send money
                  </Link>
                </div>
        ...
        <div className="p-[16px] hidden border py-8">
          <div className="flex items-center justify-center gap-3">
            <Link
              ...
              className="border flex items-center gap-1 p-4 py-2 text-[13px] max-w-max bg-white text-[#12604a] rounded-full"
            >
