...
export default function Header({ handleLogout, user }: any) {
  ...
  return (
    <div className="w-full min-h-[30px] relative flex items-center justify-between bg-[#12604a] border-b-4 border-[#ffcd41] p-[16px] py-[15px]">
      ...
      {open && (
        <div className="w-full h-screen fixed z-50 left-0 top-0 right-0 bg-[#FAFAF8]">
          <div className="bg-white sticky top-0 z-10 p-3 py-5 flex items-center justify-between gap-1">
            ...
            <button onClick={handleLogout} className="p-3 py-2 rounded-lg border-none outline-none font-medium border bg-[#12604a] text-white text-sm">Sign out</button>
          </div>
          <div className="p-4">
            <div className="bg-white text-sm rounded-lg p-5 py-7 flex flex-col items-center justify-center gap-8 mb-4">
              ...
              <div className="flex w-full justify-between items-center">
                ...
                <span className="text-[#252525] font-medium flex items-center gap-1">
                  <span className="bg-[#12604a]/30 text-black text-xs p-2 py-1 rounded-lg flex items-center gap-1">
